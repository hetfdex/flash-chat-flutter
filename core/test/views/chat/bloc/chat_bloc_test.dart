...
void main() {
  ...
  group('ChatChanged', () {
    blocTest(
      'emits [ChatFillInProgress] when message is null',
      build: () {
        return chatBloc;
      },
    ...
    blocTest(
      'emits [ChatFillInProgress] when message is empty',
      build: () {
        return chatBloc;
      },
    ...
    blocTest(
      'emits [ChatFillSuccess] when message is valid',
      build: () {
        return chatBloc;
      },
  ...
  group('ChatSubmitted', () {
    blocTest(
      'emits [ChatEncryptionInProgress, ChatInitial] when message is  valid',
      build: () {
        const privateKeyPEM =
    ...
    blocTest(
      'emits [ChatEncryptionInProgress, LoginFormFillSuccess] on caught error',
      build: () {
  ...
  group('CloseButtonPressed', () {
    blocTest(
      'emits [ChatFillInProgress, ChatInitial]',
      build: () {
        return chatBloc;
      },
      act: (chatBloc) {
