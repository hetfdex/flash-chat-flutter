...
void main() {
  ...
  testWidgets('correct input and tap calls event and changes state',
    ...
    expect(testDebuggerBlocDelegate.lastEvent, 'RegisterSubmitted');
    expect(testDebuggerBlocDelegate.currentState, 'RegisterFillSuccess');
    expect(testDebuggerBlocDelegate.nextState, 'RegisterValidateInProgress');
  });
